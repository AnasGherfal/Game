class SceneManager {
    constructor(game) {
        ...
        this.mario = new SackBoy(this.game, 2.5 * PARAMS.BLOCKWIDTH, 0 * PARAMS.BLOCKWIDTH);
    ...
    draw(ctx) {
        ...
        if (PARAMS.DEBUG) {
            let xV = "xV=" + Math.floor(this.game.sackboy.velocity.x);
            let yV = "yV=" + Math.floor(this.game.sackboy.velocity.y);
